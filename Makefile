venv:
	python3 -m venv .venv
install:
	. .venv/bin/activate && pip install -U pip && pip install ruff pytest pyyaml pandas numpy scikit-learn requests python-dateutil nasdaq-data-link pyarrow fastparquet
ingest:
